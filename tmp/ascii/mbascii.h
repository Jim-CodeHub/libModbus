 ...
 **/
struct mbascii_rtu_crc{
	unsigned char crcLo;
	unsigned char crcHi;
};

/**
 *	@brief RTU mbascii (ADU) structure
 **/
struct mbascii_rtu_adu{
	struct mbascii_rtu_chk chk;
	struct mbascii_rtu_crc crc; 
};
 ...
 **/
struct mbascii_asc_lrc{
	char lrcHi;
	char lrcLo;
};

/**
 *	@brief ASCII mbascii (ADU) structure
 **/
struct mbascii_asc_adu{
	struct mbascii_asc_chk chk;
	struct mbascii_asc_lrc lrc; 
};
 ...
 *------------------------------------------------------------------------------------------------------------------
*/
struct mbascii_rtu_adu mbascii_rtu_set(unsigned char address, unsigned char funCode, const void *data, size_t size);
struct mbascii_asc_adu mbascii_asc_set(unsigned char address, unsigned char funCode, const void *data, size_t size);
